...
class TicketUtcResponseContractTest {
    ...
    return Stream.of(
        Arguments.of(
            ...
            (Function<LocalDateTime, Object>)
                time -> new TicketQrResponse("jwt", TicketStatus.UNUSED, time, time),
            List.of("issued_at", "expires_at")),
        Arguments.of(
            "EntryCheckInResponse",
            (Function<LocalDateTime, Object>) time -> EntryCheckInResponse.of(1L, time),
            List.of("used_at")));
  }
