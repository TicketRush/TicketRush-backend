...
public enum TossErrorCode {
  ...
  INVALID_CARD(ErrorStatus.PAYMENT_METHOD_REJECTED),
  REJECT_CARD(ErrorStatus.PAYMENT_METHOD_REJECTED),
  EXCEED_MAX_DAILY_PAYMENT(ErrorStatus.PAYMENT_LIMIT_EXCEEDED),
  EXCEED_MAX_MONTHLY_PAYMENT_AMOUNT(ErrorStatus.PAYMENT_LIMIT_EXCEEDED),
  EXCEED_MAX_PAYMENT_AMOUNT(ErrorStatus.PAYMENT_LIMIT_EXCEEDED),
  EXCEED_MAX_ONE_DAY_AMOUNT(ErrorStatus.PAYMENT_LIMIT_EXCEEDED),
