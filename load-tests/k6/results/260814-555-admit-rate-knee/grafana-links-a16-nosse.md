...
### 호스트 CPU
저장 파일명: `graph-host-cpu-a16-nosse.png`
...
저장 파일명: `graph-host-cpu-modes-a16-nosse.png`
...
저장 파일명: `graph-kafka-consumer-lag-a16-nosse.png`
...
저장 파일명: `graph-consumer-threads-a16-nosse.png`
...
저장 파일명: `graph-container-mem-a16-nosse.png`
...
저장 파일명: `graph-container-mem-infra-a16-nosse.png`
...
저장 파일명: `graph-hikari-tomcat-a16-nosse.png`
...
저장 파일명: `graph-connections-a16-nosse.png`
